...
# Update and start the AV API microservice
docker pull byuoitav/rpi-av-api:latest
docker kill rpi-av-api
docker rm rpi-av-api
...
# Update and start the telnet microservice
docker pull byuoitav/rpi-telnet-microservice:latest
docker kill rpi-telnet-microservice
docker rm rpi-telnet-microservice
docker pull byuoitav/rpi-telnet-microservice:latest
...
# Update and start the PJLink microservice
docker pull byuoitav/rpi-pjlink-microservice:latest
docker kill rpi-pjlink-microservice
docker rm rpi-pjlink-microservice
docker pull byuoitav/rpi-pjlink-microservice:latest
...
# Update and start the configuration database microservice
docker pull byuoitav/rpi-configuration-database:latest
docker kill rpi-configuration-database
docker rm rpi-configuration-database
...
# Update and start the Sony control microservice
docker pull byuoitav/rpi-sony-control-microservice:latest
docker kill rpi-sony-control-microservice
docker rm rpi-sony-control-microservice
docker pull byuoitav/rpi-sony-control-microservice:latest
...
# Update and start the raspi-tp frontend microservice
docker pull byuoitav/rpi-raspi-tp:latest
docker kill rpi-raspi-tp
docker rm rpi-raspi-tp
